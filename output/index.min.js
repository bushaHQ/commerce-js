var BushaCommerce = (function () {
  ...
  class Y {
    ...
    resolve(e, t) {
      ...
      if (!B(n)) throw new TypeError("conditions must return a schema object");
      return n.resolve(t);
    }
  }
  const J = "$",
  ...
  function Q(e) {
    function t(
      ...
      if (!n.sync) {
        try {
          Promise.resolve(!!F || l.call(b, t, b)).then(x, w);
        } catch (e) {
          w(e);
        }
        return;
  ...
  function ee(e, t = new Map()) {
    if (B(e) || !e || "object" != typeof e) return e;
  ...
  class te {
    ...
    when(e, t) {
      ...
      return (
        ...
        s.conditions.push(
          "function" == typeof t ? new Y(n, t) : Y.fromOptions(n, t)
        ),
        s
      );
    }
          ...
          for (const t of Object.keys(e)) {
            ...
            n.add(t),
              H.isRef(s) && s.isSibling
                ? i(s.path, t)
                : B(s) && "deps" in s && s.deps.forEach((e) => i(e, t));
          }
  ...
  function $e() {
    ...
    null == s || s.removeEventListener("click", $e),
  ...
  const Oe = (s) => {
    ...
    if (s.origin === r.origin && _e) {
      ...
      s.data.status === o && ($e(), _e.onClose && _e.onClose(s.data)),
        "COMPLETED" === s.data.status &&
          ($e(), _e.onSuccess && _e.onSuccess(s.data));
    }
  };
  return function (u) {
    !(function () {
      ...
      (function (e) {
        xe({
          local_amount: le().required(),
          local_currency: oe().required(),
          public_key: oe().required(),
          reference: oe().optional(),
          meta: xe({ email: oe().email(), name: oe() }).optional(),
        }).validateSync(e);
      })(u),
      (_e = u);
    const l = (function () {
    ...
    l.appendChild(d), d.submit(), window.addEventListener("message", Oe);
  };
})();
